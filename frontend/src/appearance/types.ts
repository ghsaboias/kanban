...
// Legacy M&A presets for backward compatibility
export type MAPreset = 'pipeline-review' | 'diligence-tracker' | 'ic-presentation' | 'night-work' | 'redline-legal' | 'deal-room-readout' | 'analytics-view'
